...
const site = 'http://pi0wqgv3q.bkt.clouddn.com/'
          ...
          <div className='video-sidebar'>
            ...
            <Tabs defaultActiveKey='1' onChange={callback}>
              <TabPane tab='关于本片' key='1'>
                <h1>{movie.title}</h1>
                <dl>
                  <dt>豆瓣评分：<span style={{ backgroundColor: '#52c41a', borderRadius: '20%', paddingLeft: '5px', paddingRight: '5px' }}>{movie.rate}</span> 分</dt>
